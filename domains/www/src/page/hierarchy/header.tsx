...
function MainLink(
  ...
  return (
    <a
      ...
      class={[
        "group",
        "font-serif text-3xl font-semibold no-underline md:text-4xl",
    ...
    >
      <span
        class={[
          ...
          !props.hidden &&
            "motion-safe:group-hover:filter-(--spooky-filter) motion-safe:group-focus-visible:filter-(--spooky-filter)",
        ]}
            ...
            {(color, index) => (
              <span
                ...
                class={[
                  ...
                  "group-focus-visible:translate-y-(--header-translate) group-focus-visible:opacity-100",
