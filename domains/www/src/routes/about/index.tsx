    ...
    <Root header={<H1>About Eric</H1>}>
      ...
      <div class="sps-prose">
        <p>
          ...
          Engineer {exp.casualYearsExperience} years later, I’m still chasing that same high.
        </p>
        <p>
          I have worked for the last {exp.professionalYearsExperience} years at a few moderately
          successful, web-SaaS startups writing code and building product.
        </p>
        <p>
          You can read my <a href={paths.about.resume()}>résumé</a> online.
        </p>
        <p>
          These days I have been thinking about what it means to be an engineer today. Why do we do
          the things we do? What values have served me, and do I want to pass those values on?
