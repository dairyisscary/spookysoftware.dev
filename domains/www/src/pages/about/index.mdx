...
first lines of CSS trying to make the background of my profile a baller shade of <span style="color:#FC3F93">Fuchsia</span>.
As an adult, card-carrying Software Engineer {exp.casualYearsExperience} years later, I’m still trying to get that same high.
