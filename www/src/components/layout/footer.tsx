    ...
    <footer className="flex items-center mb-20">
      ...
      <div className="flex items-center w-32">
        <NewTabLink href="/rss.xml" className="flex-1 mr-4">
          ...
          <span className="sr-only">Spooky Software Blog RSS Feed</span>
        </NewTabLink>
        <NewTabLink
        ...
        >
          ...
          <span className="sr-only">Spooky Software GitHub</span>
        </NewTabLink>
        <NewTabLink
        ...
        >
          ...
          <span className="sr-only">Spooky Software YouTube</span>
        </NewTabLink>
      </div>
    </footer>
  );
